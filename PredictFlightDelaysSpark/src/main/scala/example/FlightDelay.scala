...
object FlightDelay {
  ...
  def main(args: Array[String]) {
    ...
    val conf = new SparkConf().setAppName("SparkFlightDelay")
    ...
    /* -------------------------------- MLLIB------------------------------------------ */
    //Creating and RDD with the FlightData to be used for training the model
    val textRDD = sc.textFile("/user/training/spark/FlightData.csv")
