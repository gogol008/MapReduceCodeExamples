--eachCat + DELIMITER + xP.getHash() + DELIMITER + xP.getUrl() + DELIMITER + positive + DELIMITER + negative + DELIMITER + xP.getUsercount();

links = load '/user/training/linkData/clean/' using PigStorage(',')
